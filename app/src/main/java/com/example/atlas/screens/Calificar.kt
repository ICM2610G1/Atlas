            ...
            Column(
                ...
                Row(
                    ...
                    for (i in 1..5) {
                        IconButton(onClick = { modelo.actualizarCalificacion(i) }) {
                            Icon(
                                imageVector = if (i <= estado.calificacion)
                                    Icons.Filled.Star else Icons.Outlined.Star,
                                contentDescription = "Estrella $i",
                                tint = if (i <= estado.calificacion)
                ...
                TextField(
                    ...
                    modifier = Modifier
                        ...
                        .padding(top = 8.dp),
                    placeholder = {
                        Text("Agregue comentarios adicionales...")
                    },
                ...
                Row(
                    ...
                    DefaulButton("Enviar Calificación", 240, 50) {
                        Toast.makeText(
                            context,
